...
Q_CONSTINIT const QMetaObject LoginPageController::staticMetaObject = { {
    ...
    nullptr,
    qt_metaTypeArray<
        // property 'readyToContinue'
        bool,
        // Q_OBJECT / Q_GADGET
        LoginPageController,
        // method 'readyToContinueChanged'
        void,
...
void LoginPageController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->readyToContinueChanged(); break;
        case 1: _t->onLoginButtonClicked((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LoginPageController::*)();
            if (_t _q_method = &LoginPageController::readyToContinueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->readyToContinue(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setReadyToContinue(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void LoginPageController::readyToContinueChanged()
{
