...
Στην δεξιά πλευρά, στην περιοχή Releases, από κάτω υπάρχουν 3 tags. Με κλικ εκεί εμφανίζονται τρεις εκδόσεις, εφόσον κάποιος χρησιμοποιεί windows πρέπει να επιλέξει την έκδοση με τον τίτλο v0.0.2-win, αλλιώς μπορεί να πατήσει τον παρακάτω σύνδεσμο: https://github.com/dimitrisDlt/pensionCalculator/releases/tag/v0.0.2-win.
